...
// motivational subtitle that updates based on the chosen goal, and a primary
// "Set goal" CTA + secondary "I'll set my goal later" link.

class _ReadingGoalStep extends StatefulWidget {
  const _ReadingGoalStep({
  ...
  @override
  State<_ReadingGoalStep> createState() => _ReadingGoalStepState();
}

class _ReadingGoalStepState extends State<_ReadingGoalStep> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Pill input (white, sits on the warm onboarding background)
          Container(
          ...
          // Motivation copy — updates live with the entered number
          AnimatedSwitcher(
          ...
          // Primary CTA — full-width black pill (matches Fable style)
          SizedBox(
            width: double.infinity,
            child: FilledButton(
              ...
              child: Text(
                context.l10n.onboardingGoalCta,
                style: GoogleFonts.manrope(
                  fontSize: 16,
                  fontWeight: FontWeight.w600,
                ),
          ...
          SizedBox(
            ...
            child: TextButton(
              ...
              child: Text(
                context.l10n.onboardingGoalSkip,
                style: GoogleFonts.manrope(
                  fontSize: 15,
                  fontWeight: FontWeight.w600,
                ),
...
// ─── Step 7: Currently reading ───────────────────────────────────────────────
//
// Two compact fields (title + optional author). No book API search yet —
// shipping the schema and the UX now, lookup can be added later.

class _CurrentlyReadingStep extends StatefulWidget {
  const _CurrentlyReadingStep({
  ...
  @override
  State<_CurrentlyReadingStep> createState() => _CurrentlyReadingStepState();
}

class _CurrentlyReadingStepState extends State<_CurrentlyReadingStep> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Search-style input (visually mirrors Fable's screenshot)
          Container(
            padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 4),
            decoration: BoxDecoration(
              color: Colors.white,
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: context.l10n.onboardingCurrentlyReadingHint,
          ...
          // Optional author field (only shown when title has content)
          AnimatedSize(
            duration: const Duration(milliseconds: 220),
            curve: Curves.easeOutCubic,
            child: _hasTitle
          ...
          // Primary CTA — disabled until a title is entered (matches Fable)
          SizedBox(
            width: double.infinity,
            child: FilledButton(
              style: FilledButton.styleFrom(
              ...
              child: Text(
                context.l10n.onboardingCurrentlyReadingNext,
                style: GoogleFonts.manrope(
                  fontSize: 16,
                  fontWeight: FontWeight.w600,
                ),
          ...
          SizedBox(
            ...
            child: TextButton(
              ...
              onPressed: widget.onSkip,
              child: Text(
                context.l10n.onboardingCurrentlyReadingNothing,
                style: GoogleFonts.manrope(
                  fontSize: 15,
                  fontWeight: FontWeight.w600,
                ),
